...
public class Encadrant implements Serializable {
    ...
    public Encadrant(String nom, String prenom, String adresse, String telephone, String email, String gender, Departement departement) {
        this.nom = nom;
        this.prenom = prenom;
        this.adresse = adresse;
        this.telephone = telephone;
    ...
    public Encadrant(String login, String password, String nom, String prenom, String adresse, String telephone, String email, String gender, Departement departement) {
        this.login = login;
