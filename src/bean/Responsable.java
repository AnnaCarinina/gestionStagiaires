...
public class Responsable  implements Serializable{
    ...
    public Responsable(String nom, String prenom, String adresse, String telephone, String email, String gender, Departement departement) {
        this.nom = nom;
        this.prenom = prenom;
        this.adresse = adresse;
        this.telephone = telephone;
    ...
    public Responsable(String login, String password, String nom, String prenom, String adresse, String telephone, String email, String gender, Departement departement) {
        this.login = login;
