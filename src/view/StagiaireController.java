...
public class StagiaireController implements Initializable {
    ...
    public void ajoute(ActionEvent actionEventAdd) {
     ...
     private Stagiaire getParam(ActionEvent actionEvent) {
        ...
        if (!nom.getText().equals("") && !prenom.getText().equals("") && !dateNaissance.getEditor().getText().equals("") && !gender.equals("") && !etablissement.getText().equals("") && !niveau.getText().equals("") && !filiere.getText().equals("") && !telephone.getText().equals("") && !adresse.getText().equals("") && !email.getText().equals("") && !stageeComboBox.getValue().equals(null) && !departementComboBox.getValue().equals(null) && !encadrantComboBox.getValue().equals(null)) {
            Stagiaire stagiaire = new Stagiaire(nom.getText(), prenom.getText(), DateUtil.convert(dateNaissance.getEditor().getText()), gender, etablissement.getText(), niveau.getText(), filiere.getText(), telephone.getText(), adresse.getText(), email.getText(), stageeComboBox.getValue(), departementComboBox.getValue(), encadrantComboBox.getValue());
            return stagiaire;
        }
        alert(actionEvent);
        return null;
